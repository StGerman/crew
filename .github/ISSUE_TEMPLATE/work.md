...
- [ ] <!-- A guard test named as a sentence: `a_thing_holds_under_the_condition`. -->

## Open

<!-- A decision this issue still needs. Delete this section when nothing is undecided. While a question remains here, the issue is not dispatchable. -->

## Triggered by

<!-- Who, the date, and what they were doing. -->
